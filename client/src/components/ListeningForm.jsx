  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl shadow-lg p-4 md:p-6 border border-indigo-200">
        ...
        {/* Instructions */}
        <div className="bg-red-50 border border-red-300 rounded-lg p-2 md:p-3 mb-3 md:mb-4">
          <p className="text-red-900 text-xs md:text-sm font-medium">
      ...
      >
        <div className="p-4 md:p-6 border-b border-gray-200 bg-gray-50">
          ...
          {currentSectionData.context && (
            <p className="text-gray-700 text-xs md:text-sm">{currentSectionData.context}</p>
          )}
        </div>
        ...
        <div className="p-4 md:p-6 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-pink-50">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-2">
            <h4 className="font-semibold text-gray-900 text-sm md:text-base">🎵 Audio Recording:</h4>
          ...
          <button
            ...
            className={`w-full py-3 px-6 rounded-lg font-bold transition-all duration-200 min-h-[44px] ${
          ...
          {blueprint.playOnce && !audioPlayed.includes(currentSection) && (
            <p className="text-xs md:text-sm text-red-700 mt-2 font-medium">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-3">
            ...
            {currentSection < sections.length - 1 ? (
              ...
              <button
                ...
                className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white px-8 py-3 rounded-lg font-bold transition-all duration-200 shadow-lg min-h-[44px] w-full sm:w-auto"
              >
                Submit Test ✓
              </button>
            )}
